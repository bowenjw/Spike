...
import { ISystem, IwarnningSystem, guildDB } from '../../util/schema/guilds';
import { banDmEmbed, buttons, dmEmbed, removeWarnEmbed, viewWarningMessageRender } from '../warningRender';
