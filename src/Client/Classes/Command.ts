...
import { ChatInputCommandBuilders, ReturnableInteraction } from '../util';
...
export class ChatInputCommand extends Command<ChatInputCommandBuilders, ChatInputCommandInteraction> {
	 ...
	 * @returns The modified object
	 */
    setBuilder(input: ChatInputCommandBuilders | ((slashCommandBuilder: SlashCommandBuilder) => ChatInputCommandBuilders)): this {
...
export class ContextMenuCommand extends Command<ContextMenuCommandBuilder, ContextMenuCommandInteraction> {
	 ...
	 */
    public setBuilder(
        input: ContextMenuCommandBuilder | ((contextMenuCommandBuilder: ContextMenuCommandBuilder) => ContextMenuCommandBuilder),
    ): this {
        if (typeof input === 'function') {
