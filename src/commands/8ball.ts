 ...
 */
export async function execute(_client:ExtendedClient, interaction: ChatInputCommandInteraction) {
    let reply = '';
    ...
    const embed = new EmbedBuilder()
        ...
        .setDescription('The Magic 8 Ball™ has all the answers to all of your most pressing questions!')
        .addFields(
            { name: 'Question', value: interaction.options.getString('question', true) },
