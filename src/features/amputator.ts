import { ApplicationCommandType, ChatInputCommandInteraction, Interaction, MessageContextMenuCommandInteraction } from "discord.js";
...
export async function amputator(interaction:ChatInputCommandInteraction | MessageContextMenuCommandInteraction) {
